...
myFolder = 'F:\Project\Test\resampling\resampling\Original\ucid\editedNew';
...
%im  = imread('Photoshop_Resampled/ucid00068sp.tif');
...
dlmwrite('ThousandImages.csv',feature_arrayO,'-append');
