function [f1,f3,f4,f5] = extractFeaturesFunctionNew(img)

aux_fun = @(block_info) YourFunction3(block_info.data);
result = blockproc(img,[256 256], aux_fun, 'TrimBorder', false);
%periodicitymap = blockproc(img,[256 256], aux_fun, 'TrimBorder', false);
...
%Use this to prepare dataset
%dlmwrite('GetDataNew.csv',feature_arrayO,'-append');

%%use this for predicting
dlmwrite('ImageFeaturesPredict2.csv',feature_arrayO)
